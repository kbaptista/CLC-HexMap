...
public class HexGridChunk : MonoBehaviour
{
    ...
    public HexMesh terrain, rivers, water, waterShore, estuaries, roads;
    ...
    /// <summary>
    /// Remplie le triangle de la cellule donnée défini par
    /// le centre et le côté de la cellule de la direction donnée
    /// </summary>
    ...
    void Triangulate(HexDirection direction, HexCell cell)
    {
        ...
        if (direction <= HexDirection.SE)
            TriangulateConnection(direction, cell, e); if (cell.IsUnderwater)
        {
        ...
        if (!cell.IsUnderwater)
        {
            ...
            if (reversed)
            {
                rivers.AddTriangleUV(
                    new Vector2(0.5f, .4f), new Vector2(1f, .2f), new Vector2(0f, 0.2f)
                );
            }
            else
            {
                rivers.AddTriangleUV(
                    new Vector2(0.5f, 0.4f), new Vector2(0f, .6f), new Vector2(1f, .6f)
                );
            }
        }
    }
    ...
    {
        if (hasRoadThroughCellEdge == true)
        {
